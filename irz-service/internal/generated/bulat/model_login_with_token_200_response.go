...
// LoginResponseAsLoginWithToken200Response is a convenience function that returns LoginResponse wrapped in LoginWithToken200Response
func LoginResponseAsLoginWithToken200Response(v *LoginResponse) LoginWithToken200Response {
	return LoginWithToken200Response{
		LoginResponse: v,
	}
}
...
func (dst *LoginWithToken200Response) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into LoginResponse
	err = newStrictDecoder(data).Decode(&dst.LoginResponse)
	if err == nil {
		jsonLoginResponse, _ := json.Marshal(dst.LoginResponse)
		if string(jsonLoginResponse) == "{}" { // empty struct
			dst.LoginResponse = nil
		} else {
			if err = validator.Validate(dst.LoginResponse); err != nil {
				dst.LoginResponse = nil
			} else {
				match++
			}
...
func (obj *LoginWithToken200Response) GetActualInstance() (interface{}) {
	...
	if obj.LoginResponse != nil {
		return obj.LoginResponse
	}
