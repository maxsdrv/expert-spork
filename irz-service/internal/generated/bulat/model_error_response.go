...
func NewErrorResponse(error_ ErrorCode, message string) *ErrorResponse {
	this := ErrorResponse{}
	this.Error = error_
...
func (o *ErrorResponse) GetError() ErrorCode {
	if o == nil {
		var ret ErrorCode
		return ret
	}
...
func (o *ErrorResponse) GetErrorOk() (*ErrorCode, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *ErrorResponse) SetError(v ErrorCode) {
	o.Error = v
}
