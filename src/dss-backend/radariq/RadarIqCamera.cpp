  ...
  m_hwInfoSignals{std::make_unique<core::DeviceHwInfoSignals>()}
{
    ...
    connect(
        m_connection.get(),
        &RadarIqConnection::cameraCoordinatesUpdated,
        this,
        &RadarIqCamera::updateCameraCoordinates);
    connect(
        m_connection.get(),
...
void RadarIqCamera::updateCameraCoordinates(
    const OARadarIqGeo_coordinate& coordinates)
{
