...
class OASkycopeSerializerSettings {
public:
    ...
    static OASkycopeSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new OASkycopeSerializerSettings();
        }
        return instance;
    }

private:
    explicit OASkycopeSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static OASkycopeSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

OASkycopeSerializerSettings * OASkycopeSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OASkycopeSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OASkycopeSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const OASkycopeObject &value) {
    return value.asJson();
}

QString toStringValue(const OASkycopeEnum &value) {
    return value.asJson();
}

QString toStringValue(const OASkycopeHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const OASkycopeObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const OASkycopeEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const OASkycopeHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, OASkycopeObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, OASkycopeEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, OASkycopeHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), OASkycopeSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(OASkycopeObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(OASkycopeEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(OASkycopeHttpFileElement &value, const QJsonValue &jval) {
