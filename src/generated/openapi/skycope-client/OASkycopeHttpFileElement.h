...
#ifndef OASkycope_HTTP_FILE_ELEMENT_H
#define OASkycope_HTTP_FILE_ELEMENT_H
...
class OASkycopeHttpFileElement {
...
Q_DECLARE_METATYPE(OASkycope::OASkycopeHttpFileElement)

#endif // OASkycope_HTTP_FILE_ELEMENT_H
