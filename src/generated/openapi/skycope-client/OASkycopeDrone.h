...
#ifndef OASkycopeDrone_H
#define OASkycopeDrone_H
...
class OASkycopePairedRC;
class OASkycopeSharedNames;
class OASkycopeSpoofStatus;
class OASkycopeThreat;

class OASkycopeDrone : public OASkycopeObject {
public:
    OASkycopeDrone();
    OASkycopeDrone(QString json);
    ~OASkycopeDrone() override;
    ...
    QMap<QString, QList<OASkycopeGps>> getGpsSector() const;
    void setGpsSector(const QMap<QString, QList<OASkycopeGps>> &gps_sector);
    ...
    QString getGuiIndex() const;
    void setGuiIndex(const QString &gui_index);
    bool is_gui_index_Set() const;
    bool is_gui_index_Valid() const;
    ...
    OASkycopePairedRC getPairedRc() const;
    void setPairedRc(const OASkycopePairedRC &paired_rc);
...
private:
    ...
    QMap<QString, QList<OASkycopeGps>> m_gps_sector;
    ...
    QString m_gui_index;
    bool m_gui_index_isSet;
    bool m_gui_index_isValid;
...
Q_DECLARE_METATYPE(OASkycope::OASkycopeDrone)

#endif // OASkycopeDrone_H
