...
#ifndef OARadarIq_HTTP_FILE_ELEMENT_H
#define OARadarIq_HTTP_FILE_ELEMENT_H
...
class OARadarIqHttpFileElement {
...
Q_DECLARE_METATYPE(OARadarIq::OARadarIqHttpFileElement)

#endif // OARadarIq_HTTP_FILE_ELEMENT_H
