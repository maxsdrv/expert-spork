...
type SensorsResponse struct {
	...
	SensorInfos   []*SensorsResponse_SensorInfo `protobuf:"bytes,1,rep,name=sensor_infos,json=sensorInfos,proto3" json:"sensor_infos,omitempty"`
...
func (x *SensorsResponse) GetSensorInfos() []*SensorsResponse_SensorInfo {
	if x != nil {
...
type SensorsResponse_SensorInfo struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	SensorId *string                `protobuf:"bytes,1,opt,name=sensor_id,json=sensorId,proto3,oneof" json:"sensor_id,omitempty"`
...
func (x *SensorsResponse_SensorInfo) Reset() {
	*x = SensorsResponse_SensorInfo{}
	mi := &file_sensor_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SensorsResponse_SensorInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SensorsResponse_SensorInfo) ProtoMessage() {}

func (x *SensorsResponse_SensorInfo) ProtoReflect() protoreflect.Message {
	mi := &file_sensor_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SensorsResponse_SensorInfo.ProtoReflect.Descriptor instead.
func (*SensorsResponse_SensorInfo) Descriptor() ([]byte, []int) {
	return file_sensor_proto_rawDescGZIP(), []int{0, 0}
}

func (x *SensorsResponse_SensorInfo) GetSensorId() string {
	if x != nil && x.SensorId != nil {
		return *x.SensorId
	}
	return ""
...
func (x *SensorsResponse_SensorInfo) GetJammerIds() []string {
	if x != nil {
		return x.JammerIds
	}
	return nil
...
func (x *SensorsResponse_SensorInfo) GetType() SensorType {
	if x != nil && x.Type != nil {
		return *x.Type
	}
...
func (x *SensorsResponse_SensorInfo) GetModel() string {
...
func (x *SensorsResponse_SensorInfo) GetSerial() string {
...
func (x *SensorsResponse_SensorInfo) GetSwVersion() string {
...
const file_sensor_proto_rawDesc = "" +
	"\n" +
	"\fsensor.proto\x12\x06api.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x10components.proto\"\xa0\x03\n" +
	"\x0fSensorsResponse\x12M\n" +
	"\fsensor_infos\x18\x01 \x03(\v2\".api.v1.SensorsResponse.SensorInfoB\x06\xbaH\x03\xc8\x01\x01R\vsensorInfos\x1a\xbd\x02\n" +
	"\n" +
	"SensorInfo\x12-\n" +
...
var file_sensor_proto_goTypes = []any{
	...
	(*SensorInfoDynamicRequest)(nil),   // 3: api.v1.SensorInfoDynamicRequest
	(*SensorInfoDynamicResponse)(nil),  // 4: api.v1.SensorInfoDynamicResponse
	(*SetJammerModeRequest)(nil),       // 5: api.v1.SetJammerModeRequest
	(*SensorsResponse_SensorInfo)(nil), // 6: api.v1.SensorsResponse.SensorInfo
...
var file_sensor_proto_depIdxs = []int32{
	6,  // 0: api.v1.SensorsResponse.sensor_infos:type_name -> api.v1.SensorsResponse.SensorInfo
	7,  // 1: api.v1.SensorInfoDynamicResponse.position:type_name -> api.v1.GeoPosition
	8,  // 2: api.v1.SensorInfoDynamicResponse.position_mode:type_name -> api.v1.GeoPositionMode
	9,  // 3: api.v1.SensorInfoDynamicResponse.workzones:type_name -> api.v1.WorkzoneSector
	1,  // 4: api.v1.SensorInfoDynamicResponse.jammer_mode:type_name -> api.v1.JammerMode
	10, // 5: api.v1.SensorInfoDynamicResponse.hw_info:type_name -> api.v1.HwInfo
	1,  // 6: api.v1.SetJammerModeRequest.jammer_mode:type_name -> api.v1.JammerMode
	0,  // 7: api.v1.SensorsResponse.SensorInfo.type:type_name -> api.v1.SensorType
	11, // 8: api.v1.SensorService.Sensors:input_type -> google.protobuf.Empty
	3,  // 9: api.v1.SensorService.SensorInfoDynamic:input_type -> api.v1.SensorInfoDynamicRequest
	5,  // 10: api.v1.SensorService.SetJammerMode:input_type -> api.v1.SetJammerModeRequest
	2,  // 11: api.v1.SensorService.Sensors:output_type -> api.v1.SensorsResponse
	4,  // 12: api.v1.SensorService.SensorInfoDynamic:output_type -> api.v1.SensorInfoDynamicResponse
