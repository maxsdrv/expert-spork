...
type JammersResponse struct {
	...
	JammerInfos   []*JammersResponse_JammerInfo `protobuf:"bytes,1,rep,name=jammer_infos,json=jammerInfos,proto3" json:"jammer_infos,omitempty"`
...
func (x *JammersResponse) GetJammerInfos() []*JammersResponse_JammerInfo {
	if x != nil {
...
type JammersResponse_JammerInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JammerId      *string                `protobuf:"bytes,1,opt,name=jammer_id,json=jammerId,proto3,oneof" json:"jammer_id,omitempty"`
...
func (x *JammersResponse_JammerInfo) Reset() {
	*x = JammersResponse_JammerInfo{}
	mi := &file_jammer_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JammersResponse_JammerInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JammersResponse_JammerInfo) ProtoMessage() {}

func (x *JammersResponse_JammerInfo) ProtoReflect() protoreflect.Message {
	mi := &file_jammer_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JammersResponse_JammerInfo.ProtoReflect.Descriptor instead.
func (*JammersResponse_JammerInfo) Descriptor() ([]byte, []int) {
	return file_jammer_proto_rawDescGZIP(), []int{0, 0}
}

func (x *JammersResponse_JammerInfo) GetJammerId() string {
	if x != nil && x.JammerId != nil {
		return *x.JammerId
	}
	return ""
...
func (x *JammersResponse_JammerInfo) GetModel() string {
...
func (x *JammersResponse_JammerInfo) GetSerial() string {
...
func (x *JammersResponse_JammerInfo) GetSwVersion() string {
...
func (x *JammersResponse_JammerInfo) GetSensorId() string {
...
func (x *JammersResponse_JammerInfo) GetGroupId() string {
	if x != nil && x.GroupId != nil {
		return *x.GroupId
	}
	return ""
...
const file_jammer_proto_rawDesc = "" +
	"\n" +
	"\fjammer.proto\x12\x06api.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x10components.proto\"\x9b\x03\n" +
	"\x0fJammersResponse\x12M\n" +
	"\fjammer_infos\x18\x01 \x03(\v2\".api.v1.JammersResponse.JammerInfoB\x06\xbaH\x03\xc8\x01\x01R\vjammerInfos\x1a\xb8\x02\n" +
	"\n" +
	"JammerInfo\x12-\n" +
...
var file_jammer_proto_goTypes = []any{
	...
	(*JammerInfoDynamicRequest)(nil),   // 2: api.v1.JammerInfoDynamicRequest
	(*JammerInfoDynamicResponse)(nil),  // 3: api.v1.JammerInfoDynamicResponse
	(*GroupsResponse)(nil),             // 4: api.v1.GroupsResponse
	(*JammerGroup)(nil),                // 5: api.v1.JammerGroup
	(*SetJammerBandsRequest)(nil),      // 6: api.v1.SetJammerBandsRequest
	(*Band)(nil),                       // 7: api.v1.Band
	(*BandOptions)(nil),                // 8: api.v1.BandOptions
	(*JammerTimeoutStatus)(nil),        // 9: api.v1.JammerTimeoutStatus
	(*JammersResponse_JammerInfo)(nil), // 10: api.v1.JammersResponse.JammerInfo
...
var file_jammer_proto_depIdxs = []int32{
	10, // 0: api.v1.JammersResponse.jammer_infos:type_name -> api.v1.JammersResponse.JammerInfo
	...
	7,  // 4: api.v1.JammerInfoDynamicResponse.bands:type_name -> api.v1.Band
	8,  // 5: api.v1.JammerInfoDynamicResponse.band_options:type_name -> api.v1.BandOptions
	14, // 6: api.v1.JammerInfoDynamicResponse.hw_info:type_name -> api.v1.HwInfo
	9,  // 7: api.v1.JammerInfoDynamicResponse.timeout_status:type_name -> api.v1.JammerTimeoutStatus
	5,  // 8: api.v1.GroupsResponse.jammer_groups:type_name -> api.v1.JammerGroup
	...
	6,  // 14: api.v1.JammerService.SetJammerBands:input_type -> api.v1.SetJammerBandsRequest
	0,  // 15: api.v1.JammerService.Jammers:output_type -> api.v1.JammersResponse
	3,  // 16: api.v1.JammerService.JammerInfoDynamic:output_type -> api.v1.JammerInfoDynamicResponse
	4,  // 17: api.v1.JammerService.Groups:output_type -> api.v1.GroupsResponse
...
func file_jammer_proto_init() {
	...
	file_jammer_proto_msgTypes[5].OneofWrappers = []any{}
	file_jammer_proto_msgTypes[6].OneofWrappers = []any{}
	file_jammer_proto_msgTypes[7].OneofWrappers = []any{}
	file_jammer_proto_msgTypes[9].OneofWrappers = []any{}
