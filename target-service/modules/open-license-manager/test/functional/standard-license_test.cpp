...
BOOST_AUTO_TEST_CASE(empty_test) {
	// Workaround for error: Test setup error: test tree is empty
 ...
 */
BOOST_AUTO_TEST_CASE(test_generic_license_read_file, *boost::unit_test::disabled()) {
 ...
 */
BOOST_AUTO_TEST_CASE(test_read_license_data, *boost::unit_test::disabled()) {
	const vector<string> extraArgs;
...
BOOST_AUTO_TEST_CASE(multiple_features, *boost::unit_test::disabled()) {
	vector<string> extraArgs;
