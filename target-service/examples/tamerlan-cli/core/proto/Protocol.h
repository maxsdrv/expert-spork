...
namespace mpk::drone::core::proto
{
...
struct DeviceStatus
{
    ...
    static constexpr auto type = QModbusDataUnit::InputRegisters;
...
struct ModbusParams
{
    ...
    static constexpr auto type = QModbusDataUnit::HoldingRegisters;
    static constexpr auto size = 1;
};
...
struct JammerAllChannelsControl
{
    ...
    static constexpr auto type = QModbusDataUnit::Coils;
    static constexpr auto size = 1;
};
