...
constexpr auto detectionLevelTag = "detection_level";
constexpr auto detectionThresholdTag = "detection_threshold";
    ...
    const TransmissionData& data)
{
    return QJsonObject{
        ...
        {detectionLevelTag, json::toValue(data.detectionLevel)},
        {detectionThresholdTag, json::toValue(data.detectionThreshold)},
    ...
    const QJsonValue& value)
{
    ...
    return TransmissionData{
        ...
        .detectionLevel = json::fromObject<int32_t>(object, detectionLevelTag),
        .detectionThreshold =
            json::fromObject<int32_t>(object, detectionThresholdTag),
