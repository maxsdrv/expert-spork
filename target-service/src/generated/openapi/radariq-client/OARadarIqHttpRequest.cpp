...
OARadarIqHttpRequestInput::OARadarIqHttpRequestInput() {
    initialize();
}

OARadarIqHttpRequestInput::OARadarIqHttpRequestInput(QString v_url_str, QString v_http_method) {
    initialize();
    url_str = v_url_str;
    http_method = v_http_method;
}

void OARadarIqHttpRequestInput::initialize() {
    var_layout = NOT_SET;
    url_str = "";
    http_method = "GET";
}

void OARadarIqHttpRequestInput::add_var(QString key, QString value) {
    vars[key] = value;
}

void OARadarIqHttpRequestInput::add_file(QString variable_name, QString local_filename, QString request_filename, QString mime_type) {
    OARadarIqHttpFileElement file;
...
OARadarIqHttpRequestWorker::OARadarIqHttpRequestWorker(QObject *parent, QNetworkAccessManager *_manager)
...
OARadarIqHttpRequestWorker::~OARadarIqHttpRequestWorker() {
...
QMap<QString, QString> OARadarIqHttpRequestWorker::getResponseHeaders() const {
    return headers;
}

OARadarIqHttpFileElement OARadarIqHttpRequestWorker::getHttpFileElement(const QString &fieldname) {
    if (!files.isEmpty()) {
    ...
    return OARadarIqHttpFileElement();
}

QByteArray *OARadarIqHttpRequestWorker::getMultiPartField(const QString &fieldname) {
...
void OARadarIqHttpRequestWorker::setTimeOut(int timeOutMs) {
...
void OARadarIqHttpRequestWorker::setWorkingDirectory(const QString &path) {
    if (!path.isEmpty()) {
        workingDirectory = path;
    }
}

void OARadarIqHttpRequestWorker::setResponseCompressionEnabled(bool enable) {
    isResponseCompressionEnabled = enable;
}

void OARadarIqHttpRequestWorker::setRequestCompressionEnabled(bool enable) {
    isRequestCompressionEnabled = enable;
}

int  OARadarIqHttpRequestWorker::getHttpResponseCode() const{
    return httpResponseCode;
}

QString OARadarIqHttpRequestWorker::http_attribute_encode(QString attribute_name, QString input) {
...
void OARadarIqHttpRequestWorker::execute(OARadarIqHttpRequestInput *input) {
    ...
    if (input->var_layout == ADDRESS || input->var_layout == URL_ENCODED) {
        ...
        // add files
        for (QList<OARadarIqHttpFileElement>::iterator file_info = input->files.begin(); file_info != input->files.end(); file_info++) {
    ...
    if (input->request_body.size() > 0) {
        ...
        if(!isFormData && (input->var_layout != MULTIPART) && isRequestCompressionEnabled){
            request_content.append(compress(input->request_body, 7, OARadarIqCompressionType::Gzip));
        } else {
    ...
    if (OARadarIqHttpRequestWorker::sslDefaultConfiguration != nullptr) {
        request.setSslConfiguration(*OARadarIqHttpRequestWorker::sslDefaultConfiguration);
    }
...
void OARadarIqHttpRequestWorker::on_reply_finished(QNetworkReply *reply) {
    bool codeSts = false;
...
void OARadarIqHttpRequestWorker::on_reply_timeout(QNetworkReply *reply) {
...
void OARadarIqHttpRequestWorker::process_response(QNetworkReply *reply) {
    ...
    if (!contentDispositionHdr.isEmpty()) {
        ...
        if ((contentDisposition.count() > 0) && (contentDisposition.first() == QString("attachment"))) {
            ...
            OARadarIqHttpFileElement felement;
...
QByteArray OARadarIqHttpRequestWorker::decompress(const QByteArray& data){
    
    Q_UNUSED(data);
    return QByteArray();
}

QByteArray OARadarIqHttpRequestWorker::compress(const QByteArray& input, int level, OARadarIqCompressionType compressType) {
...
QSslConfiguration *OARadarIqHttpRequestWorker::sslDefaultConfiguration;
