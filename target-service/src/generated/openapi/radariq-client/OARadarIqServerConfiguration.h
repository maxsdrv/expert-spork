 ...
 */
#ifndef OARadarIq_SERVERVCONFIGURATION_H
#define OARadarIq_SERVERVCONFIGURATION_H
...
#include <QUrl>
#include <stdexcept>
#include "OARadarIqServerVariable.h"

namespace OARadarIq {

class OARadarIqServerConfiguration {
public:
    /**
     ...
     */
    OARadarIqServerConfiguration(const QUrl &url, const QString &description, const QMap<QString, OARadarIqServerVariable> &variables)
    : _description(description),
      _variables(variables),
      _url(url){}
    OARadarIqServerConfiguration(){}
    ~OARadarIqServerConfiguration(){}
    ...
    QString URL() {
        ...
        if(!_variables.empty()){
            ...
            for (auto const& v : _variables.keys()) {
                QString name = v;
                OARadarIqServerVariable serverVariable = _variables.value(v);
    ...
    QMap<QString, OARadarIqServerVariable> _variables;
    QUrl _url;
...
#endif // OARadarIq_SERVERVCONFIGURATION_H
