...
class OAServiceSerializerSettings {
public:
    ...
    static OAServiceSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new OAServiceSerializerSettings();
        }
        return instance;
    }

private:
    explicit OAServiceSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static OAServiceSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

OAServiceSerializerSettings * OAServiceSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OAServiceSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OAServiceSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const OAServiceObject &value) {
    return value.asJson();
}

QString toStringValue(const OAServiceEnum &value) {
    return value.asJson();
}

QString toStringValue(const OAServiceHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const OAServiceObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const OAServiceEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const OAServiceHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, OAServiceObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, OAServiceEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, OAServiceHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), OAServiceSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(OAServiceObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(OAServiceEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(OAServiceHttpFileElement &value, const QJsonValue &jval) {
