...
type _TargetDataPositionDirection TargetDataPositionDirection
...
func (o *TargetDataPositionDirection) UnmarshalJSON(data []byte) (err error) {
	varTargetDataPositionDirection := _TargetDataPositionDirection{}

	err = json.Unmarshal(data, &varTargetDataPositionDirection)

	if err != nil {
		return err
	}

	*o = TargetDataPositionDirection(varTargetDataPositionDirection)
