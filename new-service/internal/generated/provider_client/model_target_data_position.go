...
type _TargetDataPosition TargetDataPosition
...
func (o *TargetDataPosition) UnmarshalJSON(data []byte) (err error) {
	varTargetDataPosition := _TargetDataPosition{}

	err = json.Unmarshal(data, &varTargetDataPosition)

	if err != nil {
		return err
	}

	*o = TargetDataPosition(varTargetDataPosition)
