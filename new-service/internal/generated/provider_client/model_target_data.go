...
type TargetData struct {
	...
	// The number of times target was detected. For all except Skycope this is the counter of detection events polled from device
	DetectCount *int64 `json:"detect_count,omitempty"`
...
// GetDetectCount returns the DetectCount field value if set, zero value otherwise.
func (o *TargetData) GetDetectCount() int64 {
	if o == nil || IsNil(o.DetectCount) {
		var ret int64
		return ret
	}
	return *o.DetectCount
}

// GetDetectCountOk returns a tuple with the DetectCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TargetData) GetDetectCountOk() (*int64, bool) {
	if o == nil || IsNil(o.DetectCount) {
		return nil, false
	}
	return o.DetectCount, true
}

// HasDetectCount returns a boolean if a field has been set.
func (o *TargetData) HasDetectCount() bool {
	if o != nil && !IsNil(o.DetectCount) {
		return true
	}
...
// SetDetectCount gets a reference to the given int64 and assigns it to the DetectCount field.
func (o *TargetData) SetDetectCount(v int64) {
	o.DetectCount = &v
}
...
func (o TargetData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DetectCount) {
		toSerialize["detect_count"] = o.DetectCount
	}
...
func (o *TargetData) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTargetData)
	...
	*o = TargetData(varTargetData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "camera_track")
		delete(additionalProperties, "alarm_ids")
		delete(additionalProperties, "cls_ids")
		delete(additionalProperties, "class_name")
		delete(additionalProperties, "attributes")
		delete(additionalProperties, "alarm_status")
		delete(additionalProperties, "position")
		delete(additionalProperties, "last_updated")
		delete(additionalProperties, "detect_count")
