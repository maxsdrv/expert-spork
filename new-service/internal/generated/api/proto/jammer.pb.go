...
type JammersResponse struct {
	...
	JammerIdList  []string               `protobuf:"bytes,1,rep,name=jammer_id_list,json=jammerIdList,proto3" json:"jammer_id_list,omitempty"`
...
func (x *JammersResponse) GetJammerIdList() []string {
	if x != nil {
		return x.JammerIdList
	}
	return nil
}
...
type JammerInfoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *JammerInfoResponse) Reset() {
	*x = JammerInfoResponse{}
	mi := &file_jammer_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JammerInfoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JammerInfoResponse) ProtoMessage() {}

func (x *JammerInfoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_jammer_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JammerInfoResponse.ProtoReflect.Descriptor instead.
func (*JammerInfoResponse) Descriptor() ([]byte, []int) {
	return file_jammer_proto_rawDescGZIP(), []int{2}
}

func (x *JammerInfoResponse) GetModel() string {
...
func (x *JammerInfoResponse) GetSerial() string {
...
func (x *JammerInfoResponse) GetSwVersion() string {
...
func (x *JammerInfoResponse) GetSensorId() string {
...
func (x *JammerInfoResponse) GetGroupId() string {
...
type JammerInfoDynamicResponse struct {
	...
	BandOptions   []*BandOptions         `protobuf:"bytes,12,rep,name=band_options,json=bandOptions,proto3" json:"band_options,omitempty"`
...
func (x *JammerInfoDynamicResponse) GetBandOptions() []*BandOptions {
	if x != nil {
...
func (x *BandOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BandOptions) ProtoMessage() {}

func (x *BandOptions) ProtoReflect() protoreflect.Message {
	mi := &file_jammer_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BandOptions.ProtoReflect.Descriptor instead.
func (*BandOptions) Descriptor() ([]byte, []int) {
	return file_jammer_proto_rawDescGZIP(), []int{9}
}

func (x *BandOptions) GetBands() []string {
	if x != nil {
		return x.Bands
	}
	return nil
...
const file_jammer_proto_rawDesc = "" +
	"\n" +
	"\fjammer.proto\x12\x06api.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x10components.proto\"I\n" +
	"\x0fJammersResponse\x126\n" +
	"\x0ejammer_id_list\x18\x01 \x03(\tB\x10\xbaH\r\xc8\x01\x01\x92\x01\a\"\x05r\x03\xb0\x01\x01R\fjammerIdList\"P\n" +
	"\x11JammerInfoRequest\x12-\n" +
	"\tjammer_id\x18\x01 \x01(\tB\v\xbaH\b\xc8\x01\x01r\x03\xb0\x01\x01H\x00R\bjammerId\x88\x01\x01B\f\n" +
	"\n" +
	"_jammer_id\"\x83\x02\n" +
	"\x12JammerInfoResponse\x12!\n" +
	"\x05model\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01H\x00R\x05model\x88\x01\x01\x12\x1b\n" +
	"\x06serial\x18\x03 \x01(\tH\x01R\x06serial\x88\x01\x01\x12\"\n" +
	"\n" +
	"sw_version\x18\x04 \x01(\tH\x02R\tswVersion\x88\x01\x01\x12*\n" +
	"\tsensor_id\x18\n" +
	" \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01H\x03R\bsensorId\x88\x01\x01\x12\x1e\n" +
	"\bgroup_id\x18\x0f \x01(\tH\x04R\agroupId\x88\x01\x01B\b\n" +
	"\x06_modelB\t\n" +
	"\a_serialB\r\n" +
	"\v_sw_versionB\f\n" +
	"\n" +
	...
	"\x05bands\x18\v \x03(\v2\f.api.v1.BandB\x06\xbaH\x03\xc8\x01\x01R\x05bands\x126\n" +
	"\fband_options\x18\f \x03(\v2\x13.api.v1.BandOptionsR\vbandOptions\x12,\n" +
	...
	"\t_duration2\xf2\x02\n" +
	"\rJammerService\x12<\n" +
	"\aJammers\x12\x16.google.protobuf.Empty\x1a\x17.api.v1.JammersResponse\"\x00\x12E\n" +
	"\n" +
	"JammerInfo\x12\x19.api.v1.JammerInfoRequest\x1a\x1a.api.v1.JammerInfoResponse\"\x00\x12U\n" +
...
var file_jammer_proto_goTypes = []any{
	(*JammersResponse)(nil),           // 0: api.v1.JammersResponse
	(*JammerInfoRequest)(nil),         // 1: api.v1.JammerInfoRequest
	(*JammerInfoResponse)(nil),        // 2: api.v1.JammerInfoResponse
	...
	(*BandOptions)(nil),               // 9: api.v1.BandOptions
...
var file_jammer_proto_depIdxs = []int32{
	11, // 0: api.v1.JammerInfoDynamicResponse.position:type_name -> api.v1.GeoPosition
	12, // 1: api.v1.JammerInfoDynamicResponse.position_mode:type_name -> api.v1.GeoPositionMode
	13, // 2: api.v1.JammerInfoDynamicResponse.workzone:type_name -> api.v1.WorkzoneSector
	8,  // 3: api.v1.JammerInfoDynamicResponse.bands:type_name -> api.v1.Band
	9,  // 4: api.v1.JammerInfoDynamicResponse.band_options:type_name -> api.v1.BandOptions
	14, // 5: api.v1.JammerInfoDynamicResponse.hw_info:type_name -> api.v1.HwInfo
	10, // 6: api.v1.JammerInfoDynamicResponse.timeout_status:type_name -> api.v1.JammerTimeoutStatus
	6,  // 7: api.v1.GroupsResponse.jammer_groups:type_name -> api.v1.JammerGroup
	15, // 8: api.v1.JammerTimeoutStatus.started:type_name -> google.protobuf.Timestamp
	15, // 9: api.v1.JammerTimeoutStatus.now:type_name -> google.protobuf.Timestamp
	16, // 10: api.v1.JammerService.Jammers:input_type -> google.protobuf.Empty
	1,  // 11: api.v1.JammerService.JammerInfo:input_type -> api.v1.JammerInfoRequest
	1,  // 12: api.v1.JammerService.JammerInfoDynamic:input_type -> api.v1.JammerInfoRequest
	...
	0,  // 15: api.v1.JammerService.Jammers:output_type -> api.v1.JammersResponse
	2,  // 16: api.v1.JammerService.JammerInfo:output_type -> api.v1.JammerInfoResponse
	4,  // 17: api.v1.JammerService.JammerInfoDynamic:output_type -> api.v1.JammerInfoDynamicResponse
	5,  // 18: api.v1.JammerService.Groups:output_type -> api.v1.GroupsResponse
	16, // 19: api.v1.JammerService.SetJammerBands:output_type -> google.protobuf.Empty
...
func file_jammer_proto_init() {
	...
	file_jammer_proto_msgTypes[1].OneofWrappers = []any{}
