...
func convertToPosition(pos provider_client.GeoPosition) core.GeoPosition {
...
func convertToWorkZone(dssWorkZone []provider_client.WorkzoneSector) core.Workzone {
